            ...
            <div className="flex flex-col justify-between">
              ...
              <div className="flex items-center justify-between w-[20rem]">
                <div className="one">
                  <h1 className="flex items-center mb-6">
                    <FaStore className="mr-2 text-black" /> Merk:{" "}
                    {product.brand}
                  </h1>
                ...
                <div className="two">
                  ...
                  <h1 className="flex items-center mb-6 w-[10rem]">
                    <FaBox className="mr-2 text-black" /> Jumlah Stok:{" "}
              ...
              <div className="btn-container">
                <button
                  ...
                  className="bg-orange-600 hover:bg-orange-700 text-white font-semibold py-2 px-4 rounded-lg mt-4 md:mt-0"
                >
                  Add To Cart
                </button>
              </div>
